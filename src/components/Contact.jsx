...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (form.email === "") {
      ...
      emailjs
        .send(
          "service_ufcdk5q", // paste your ServiceID here (you'll get one when your service is created).
          "template_f98iolm", // paste your TemplateID here (you'll find it under email templates).
          {
            from_name: form.name,
            to_name: "delwer", // put your name here.
            from_email: form.email,
            to_email: "rashedaakhter@gmail.com", //put your email here.
            message: form.message,
          },
          "_luFQ8MSwbtWUZdZQ" //paste your Public Key here. You'll get it in your profile section.
        )
        .then(
          () => {
            setLoading(false);
